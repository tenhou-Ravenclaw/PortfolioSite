...
export const events: Event[] = [
    ...
    {
        title: "CARTA HOLDINGS SUNRISE",
        date: "2026/03/23~2026/03/27",
        desc: "CARTA HOLDINGSが主催するSUNRISEに参加した。",
        role: "参加者",
        learned: "",
    },
    {
        ...
        desc: "GENIEEのインターンシップに参加した。",
        role: "インターン生",
        learned: "",
    },
    {
        title: "GA technologies インターン",
        date: "2026/04/14",
        desc: "GA technologiesのインターンシップに参加した。",
        role: "インターン生",
        learned: "",
    },
    {
        title: "BuildWithAI Kansai",
        date: "2026/04/19",
        desc: "BuildWithAI Kansaiに参加し、TrackBのオーナー・司会を務めた。",
        url: "https://gdgkwansai.connpass.com/event/381901/",
        role: "TrackBオーナー、司会",
        learned: "",
    },
    {
        title: "GDGoC 合同新歓",
        date: "2026/05/09",
        desc: "GDGoC 合同新歓にスタッフとして参加した。",
        url: "https://gdg.community.dev/events/details/google-gdg-on-campus-university-of-osaka-osaka-japan-presents-gdg-on-campus-japan-guan-xi-he-tong-xin-huan/cohost-gdg-on-campus-kanazawa-institute-of-technology-ishikawa-japan/",
        role: "スタッフ",
        learned: "",
    },
    {
        title: "AIと音楽の融合",
        date: "2026/05/23",
        desc: "AIと音楽の融合イベントにスタッフとして参加した。",
        url: "https://gdgkwansai.connpass.com/event/388441/",
        role: "スタッフ",
        learned: "",
    },
    {
